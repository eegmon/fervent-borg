...
export default function LoginModal({ isOpen, onLoginSuccess, onClose, prosecutorsList, departmentsData }) {
  ...
  const handleLogin = (e) => {
    ...
    // prosecutorsList prop 우선 사용 (동적 계정 지원), 없으면 에러
    const list = prosecutorsList || [];
      ...
      <div className="modal-overlay">
        <div className="modal-content" style={{ maxWidth: 440, position: 'relative' }}>
          ...
          <button
            ...
            style={{ width: '100%', padding: '11px', fontWeight: 700, justifyContent: 'center', fontSize: '0.88rem', marginTop: 4 }}
          >
