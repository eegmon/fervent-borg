  ...
  asyncWrap(async (req, res) => {
    ...
    await db.execute({
      ...
      args: [
        ...
        c.reAppeal || "-",
        c.court1No !== undefined ? c.court1No : (old?.court1No || ""),
        c.court1Result !== undefined ? c.court1Result : (old?.court1Result || ""),
        c.court1Doc !== undefined ? c.court1Doc : (old?.court1Doc || ""),
        c.court1Appealed || "",
        c.court1Appellant || "",
        c.court2No !== undefined ? c.court2No : (old?.court2No || ""),
        c.court2Dismissed || "",
        c.court2Result !== undefined ? c.court2Result : (old?.court2Result || ""),
        c.court2Doc !== undefined ? c.court2Doc : (old?.court2Doc || ""),
        c.court3Appealed || "",
        c.court3Appellant || "",
        c.court3No !== undefined ? c.court3No : (old?.court3No || ""),
        c.court3Remanded || "",
        c.court3Result !== undefined ? c.court3Result : (old?.court3Result || ""),
        c.court3Doc !== undefined ? c.court3Doc : (old?.court3Doc || ""),
        c.chargeName || "",
        c.notes || "",
        c.content || "",
        c.confiscation || "",
